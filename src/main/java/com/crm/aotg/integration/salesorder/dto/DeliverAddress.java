...
public class DeliverAddress implements Serializable
{
    ...
    private final static long serialVersionUID = -2326825412262437105L;
     ...
     * @param fax
     */
    public DeliverAddress(String contact, String fax, String phone, String address1, String address2, String address3, String address4) {
        super();
    ...
    public String toString() {
        ...
        sb.append(DeliverAddress.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("contact");
        sb.append('=');
